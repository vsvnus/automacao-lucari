...
function navigateTo(section, replace = false) {
    ...
    // SDR section removed — now at admin-sdr.vin8n.online
    ...
    clients.forEach(client => {
        ...
        card.innerHTML = `
            ...
            <div class="client-card-footer">
                <button class="btn-details" onclick="navigateToClientDetails('${escapeJsString(client.slug)}')">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    Ver detalhes
                </button>
                <div style="flex:1"></div>
                <button class="btn-text" onclick="handleEditClient('${escapeJsString(client.slug)}')">
    ...
    try {
        ...
        clients.forEach(client => {
            ...
            card.innerHTML = `
                ...
                <div class="client-card-footer">
                    <button class="btn-text" style="color:var(--success);" onclick="triggerClientRun(${client.id}, '${escapeJsString(client.name)}', 'weekly')">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
                        Semanal
                    </button>
                    <button class="btn-text" style="color:var(--success);" onclick="triggerClientRun(${client.id}, '${escapeJsString(client.name)}', 'monthly')">
                    ...
                    <button class="btn-text" style="color:var(--error);" onclick="deleteRelatorioClient(${client.id}, '${escapeJsString(client.name)}')">
